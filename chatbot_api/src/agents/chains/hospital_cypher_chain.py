...
graph.refresh_schema() # Đồng bộ thay đổi gần đây vào thực thể
...
hospital_cypher_chain = GraphCypherQAChain.from_llm(
    cypher_llm=ChatOpenAI(model=HOSPITAL_CYPHER_MODEL, temperature=0.3),
    qa_llm=ChatOpenAI(model=HOSPITAL_QA_MODEL, temperature=0.3),
    graph=graph,
    verbose=True,
